...
designs="ARTIC_v3.bed ARTIC_v4.bed ARTIC_v4.1.bed ARTIC_v4.1_(alts_only).bed ARTIC_v4.1_(spiked_alts).bed \
VarSkip_1a.bed VarSkip_2a.bed Varskip_Long_1a.bed Midnight_1200.bed Resende.bed Swift.bed UNZA.bed USydney.bed"
#for f in $designs; do 
